...
%sum(sum) faz soma dos elementos matriz
...
%remove bias wich is first column at both
columns_to_remove = [1];

Theta1noBias=Theta1;
Theta2noBias=Theta2;

Theta1noBias(:,columns_to_remove)=[];
Theta2noBias(:,columns_to_remove)=[];
...
for t=1:m;
	...
	%1-back propagation
	%unica maneira fazer esta subtracao imprimi tamanhos vectores

	z2=[1; z2]; % problem op1(26,1) op2(25,1)
...
%should not be regularizing the first column of theta
